...
def parse_args():
    ...
    # parser.add_argument('config', help='train config file path',default="E:\XuyuanFiles\mmlab\mmpose-main\work_dirs\deeppose_regression_cocopaper_256x256\deeppose_regression_cocopaper_256x256.py")
...
def main():
    ...
    # path=r"E:\XuyuanFiles\mmlab\mmpose-main\work_dirs\deeppose_regression_cocopaper_256x256\deeppose_regression_cocopaper_256x256.py"
