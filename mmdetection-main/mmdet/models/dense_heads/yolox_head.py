...
class YOLOXHead(BaseDenseHead):
    ...
    def forward_single(self, x: Tensor, cls_convs: nn.Module,
        ...
        # print("yoloheadshape",x.shape)
        cls_feat = cls_convs(x)
        # print("yoloheadshape_cls",cls_feat.shape)
        reg_feat = reg_convs(x)
        # print("yoloheadshape_reg",reg_feat.shape)
    ...
    def forward(self, x: Tuple[Tensor]) -> Tuple[List]:
        ...
        """
        print()
        res=multi_apply(self.forward_single, x, self.multi_level_cls_convs,
                    self.multi_level_reg_convs,
                    self.multi_level_conv_cls,
                    self.multi_level_conv_reg,
                    self.multi_level_conv_obj)
        # print("*********head",len(res),len(res[0]),len(res[0][0]),len(res[0][0][0]),len(res[0][0][0][0]),len(res[0][0][0][0][0]),len(res[0][0][0][0][0][0]))
        return res
