...
data_root = 'E:\XuyuanFiles\csqHelpProject\keypoint_rcnn_training_pytorch\Mpaper_data_my\Mpaper_data_my'
metainfo = {'classes': ('paper',)}
...
default_hooks = dict(
    ...
    logger=dict(type='LoggerHook', interval=1),#打印日志
    param_scheduler=dict(type='ParamSchedulerHook'),#调用 ParamScheduler 的 step 方法
    checkpoint=dict(type='CheckpointHook', interval=10, max_keep_ckpts=2, save_best='coco/bbox_mAP'),#按指定间隔保存权重
    # auto coco/bbox_mAP_50 coco/bbox_mAP_75 coco/bbox_mAP_s
    visualization=dict(type='DetVisualizationHook'))#确保分布式 Sampler 的 shuffle 生效
...
log_level = 'INFO'
load_from = r'F:\HWS\mmpose-main\mmpose-main\mmdetection-main\mmdetection-main\work_dirs\rtmdection_paper\best_coco_bbox_mAP_epoch_10.pth'
resume = True
...
train_pipeline = [
    ...
    # dict(type='Pad', size=(256, 256), pad_val=dict(img=(114, 114, 114))),
    # dict(
    #     type='CachedMixUp',
    #     img_scale=(256, 256),
    #     ratio_range=(1.0, 1.0),
